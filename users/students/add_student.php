...
<div class="card card-outline rounded-0 card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a class="btn btn-sm btn-flat btn-primary" id="create_new" ><i class="fa fa-plus"></i> Add New Student</a>
		</div>
	</div>
	<div class="card-body">
        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * fullname FROM `Student_list` )  order by concat(fullname) asc ");
