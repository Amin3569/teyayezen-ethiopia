...
<div>							
<a href="../../users/index.php"  class="btn btn-primary"><i class="fas "></i>  Go back</a>
</div>	
<div>

<form method="post" action="assign.php">    
	<button type="submit" class="btn btn-primary" name="shuffle">Shuffle Students</button>
</form>

	
</div>
<div>
<a href="#" onclick="window.print()" class="btn btn-primary"><i class="icon-print icon-large"></i> Print List</a> 
</div>
...
echo "<h4>" .'<div id=\"div1\">'."<br><br><br>------------------------------------------------<br>".$i."."."".$firstpair."[".$fa."]"."[".$fs."]"."[".$fg."]".'<br><br>'.''.$i.".".$secondpair."[".$sa."]"."[".$ss."]"."[".$sg."]"."<br>------------------------------------------------<br><br><div><hr></div>".'</div>'.'</div>'.""."</h4>";
...
do {
  $vary = $vary +1;
      ...
      echo '<div><pre> # a student who did not assigned is <br><hr><br>'.$name."[".$sex."]"."[".$age."]"."[".$grade."]"."<br><hr><br></div>";
